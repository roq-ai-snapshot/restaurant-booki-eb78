  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Restaurant Booking Engine - Streamlining Your Dining Experience. Reserve Tables, Manage Reservations, and Menus All In One Place."
        />
      </Head>
      <HomeLayout>
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Restaurant Booking Engine - Streamlining Your Dining Experience. Reserve Tables, Manage Reservations, and Menus All In One Place.`}
            </Text>
            <Box
