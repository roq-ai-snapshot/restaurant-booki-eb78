      ...
      <Box rounded="md">
        ...
        <FormWrapper onSubmit={formik.handleSubmit}>
          ...
          <NumberInput
            ...
            formControlProps={{
              id: 'guests_number',
              isInvalid: !!formik.errors?.guests_number,
            }}
            name="guests_number"
            error={formik.errors?.guests_number}
            value={formik.values?.guests_number}
            onChange={(valueString, valueNumber) =>
              formik.setFieldValue('guests_number', Number.isNaN(valueNumber) ? 0 : valueNumber)
            }
          />
